...
lead-qualification-agent/
├── README.md
├── architecture_flow.png    # Diagram referenced above
...
|---|---|
| End-to-end execution — every node fires, zero errors | ![[Screenshot: n8n canvas, full green execution]] |
| Hot lead reaches the team on Slack within seconds | ![[Screenshot: Slack #hot-leads channel alert]] |
| Hot lead reaches the team on Gmail, in parallel | ![[Screenshot: Gmail HOT LEAD ALERT email]] |
| Every lead — hot, warm, or cold — lands in the CRM | ![[Screenshot: Airtable Leads CRM with score, tier, reasoning]] |
